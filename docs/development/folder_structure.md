...
Contains a [TypeSchema](https://typeschema.org/) specification which is used to [generate all model](generate_model.md) classes.
...
See also the [migration](migration.md) page.
...
More information at the [generate model](generate_model.md) page.
...
More information at the [generate table](generate_table.md) page.
